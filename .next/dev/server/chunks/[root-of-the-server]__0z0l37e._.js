...
"[project]/app/api/agent/decide/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    const { order, agentState, remainingSeconds } = await req.json();
    ...
    const decision = {
        ...
        reason: accept || acceptSurge ? `Efficiency $${efficiency.toFixed(1)} MXN/min${order.isSurge ? " (surge bonus)" : ""} — accepted.` : `Efficiency $${efficiency.toFixed(1)} MXN/min too low or shift ending — skipped.`,
        confidence: 0.7,
        timestamp: Date.now(),
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(decision);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0z0l37e._.js.map